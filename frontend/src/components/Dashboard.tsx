  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <div className="relative mx-auto w-full max-w-7xl px-5 py-10 lg:px-8">
        <section className="relative overflow-hidden rounded-3xl border border-blue-100 bg-white/90 shadow-2xl backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/90">
          <div className="absolute -right-24 -top-20 h-56 w-56 rounded-full bg-blue-500/20 blur-3xl" />
          ...
          <div className="grid gap-8 px-6 py-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-10 lg:py-12">
            <div>
              <span className="inline-flex rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-blue-600 dark:border-blue-800 dark:bg-blue-950/50 dark:text-blue-400">
                UEFA-inspired matchday booking
              </span>
              <h1 className="mt-6 max-w-2xl text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl dark:text-white">
                Lock in your seat for the biggest nights on the pitch.
              </h1>
              <p className="mt-6 max-w-2xl text-base leading-relaxed text-slate-600 lg:text-lg dark:text-slate-300">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a
                  href="/fixtures"
                  className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
                >
                  View fixtures
                </a>
              </div>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={value}
                    className="rounded-2xl border border-blue-100 bg-blue-50/50 px-4 py-4 dark:border-slate-800 dark:bg-slate-800/40"
                  >
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-900">
                <img
                ...
                <div className="absolute bottom-4 left-4 right-4 rounded-xl border border-white/20 bg-white/80 p-4 shadow-lg backdrop-blur-md dark:border-slate-700/50 dark:bg-slate-900/80">
        ...
        <div ref={gridRef} className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {featuredImages.map((image, index) => (
            <article
              ...
              className={`overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-md transition-all duration-700 ease-out will-change-transform dark:border-slate-800 dark:bg-slate-900 ${
                visibleCards[index]
